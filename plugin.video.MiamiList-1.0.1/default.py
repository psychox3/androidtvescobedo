...
addon = xbmcaddon.Addon('plugin.video.MiamiList')
...
SOURCES = [{"url": "https://raw.githubusercontent.com/vivalist/KodiLatino/master/list", "fanart": "http://1.bp.blogspot.com/-adoG1KlFxJM/Vq7f8FJLycI/AAAAAAAABR4/AqwcXSEqrX0/s320/MIAMI%2BLIST.jpg"}]



def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.MiamiList-%s]: %s" %(addon_version, string))
