...
puerto = 'aHR0cDovL3d3dy5taWZsaXgueDEwLm14L21pZmxpeDMuMC9NRU5VLlhNTA=='.decode('base64')
...
addon = xbmcaddon.Addon('plugin.video.miflix')
...
SOURCES = [{"url": puerto, "fanart": "http://www.miflix.x10.mx/fanart.jpg "}]
