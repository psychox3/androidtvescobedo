...
def PlayLiveStream(pageUrl='',Name='',Thumb='',Channel='',roomId='',roomSlug='',plot='',liVe='',streamUrl='',streamkey='',youtubekey='',sourcetype='show'):
	...
	if len(streamUrl) > 10: url=streamUrl
		...
		#url="http://mvn.vaughnsoft.net/video/edge/vmn-{domain}_{channel}" ## << From chrippa's LiveStreamer. ##
		mvnkeyURL="http://mvn.vaughnsoft.net/video/edge/vmn-%s_%s"%(DomainTag,Channel); debob({'mvnkeyURL':mvnkeyURL}); 
