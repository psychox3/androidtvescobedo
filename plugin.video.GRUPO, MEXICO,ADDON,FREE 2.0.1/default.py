...
Base = 'http://pastebin.com/raw/ytSHEep0' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.GRUPO MEXICO ADDON  FREE') #    modificar("el nombre de tu addons")
