...
def SportsDevil():
    print "SportsDevil"
    url = "http://freemediaentertainment.com/Dependencias/plugin.video.SportsDevil.zip"
...
def Dutch():
    ...
    url = "http://freemediaentertainment.com/GoldenTV/Repo.Shani.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
...
def Repo():
    ...
    url = "http://freemediaentertainment.com/Repositorys/Docshadrach.zip"
    addonsDir = xbmc.translatePath(os.path.join('special://home', 'addons')).decode("utf-8")
    packageFile = os.path.join(addonsDir, 'packages', 'isr.zip')
...
addon = xbmcaddon.Addon('plugin.video.goldenmusicpro')
...
SOURCES = [{"url": "http://legionworldtv.com/secure/mainmusic.txt", "fanart": "http://legionworldtv.com/secure/3d-girl.jpg"}]
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,No conecta. - "+str(e.reason)+",10000,"+icon+")")
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,Nueva fuente ,5000,"+icon+")")
        if not url is None:
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,Urlresolver donot support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('Golden Music Pro','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                ...
                contextMenu.append(('Agregar a los favoritos de Golden Music Pro','XBMC.RunPlugin(%s)' %fav_params))
            liz.addContextMenuItems(contextMenu)
...
#            ln+='</item>'
        ...
        if url:
            ...
            xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,Falló extraer regex. - "+"this"+",4000,"+icon+")")
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,Por favor [COLOR yellow]instala Youtube-dl[/COLOR] modulo ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,Parental Block Disabled,5000,"+icon+")")
        else:
    ...
    xbmc.executebuiltin("XBMC.Notification(Golden Music Pro,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
